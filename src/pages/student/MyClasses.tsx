...
import {
  Box, Typography, Card, CardContent, Grid, Chip, LinearProgress, Alert,
  List, ListItem, ListItemText, ListItemAvatar, Avatar, CardActions, Button
} from '@mui/material';
import {
...
import { ClassSchedule, MyClassesData } from '../../types';
                  ...
                  <List dense>
                    {classItem.teacher && (
                      <ListItem>
                        ...
                        <ListItemText
                          primary="Giáo viên"
                          secondary={classItem.teacher.name}
                        />
                      </ListItem>
                    )}
