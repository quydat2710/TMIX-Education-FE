          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={4}>
              <Card sx={{
                ...
                <Box sx={{
                  height: 100,
                  background: 'linear-gradient(135deg, #2e7d32 0%, #1b5e20 50%, #4caf50 100%)',
                  position: 'relative',
                  overflow: 'hidden',
                  '&::after': {
                    content: '""',
                ...
                <CardContent sx={{ p: 4, textAlign: 'center', mt: -8 }}>
                  ...
                  <Box sx={{
                    ...
                    p: '4px',
                    borderRadius: '50%',
                    background: 'linear-gradient(135deg, #2e7d32, #66bb6a, #1b5e20, #81c784)',
                    boxShadow: '0 4px 20px rgba(46,125,50,0.3)',
                    '@keyframes subtlePulseGreen': {
                      '0%, 100%': { boxShadow: '0 4px 20px rgba(46,125,50,0.3)' },
                      '50%': { boxShadow: '0 4px 28px rgba(46,125,50,0.45)' },
                    },
                    animation: 'subtlePulseGreen 3s ease-in-out infinite',
                  }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.5 }}>
                    <FamilyIcon sx={{ fontSize: 16, color: '#2e7d32' }} />
