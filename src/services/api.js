...
export const addChildAPI = (studentId, parentId) => axiosInstance.patch(API_CONFIG.ENDPOINTS.PARENTS.ADD_CHILD, { studentId, parentId });
export const removeChildAPI = (studentId, parentId) => axiosInstance.delete(API_CONFIG.ENDPOINTS.PARENTS.REMOVE_CHILD, { data: { studentId, parentId } });
